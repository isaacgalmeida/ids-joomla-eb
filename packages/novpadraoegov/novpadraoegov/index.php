...
<body>
    <div class="template-base">
                ...
                <div class="header-top">
                        ...
                        <div class="header-menu">
                                ...
                                <div class="header-menu-trigger" id="header-navigation">
                                    <button class="br-button small circle" type="button" aria-label="Menu"
                                        data-toggle="menu" data-target="#main-navigation" id="navigation"><i
                                            class="fas fa-bars tema-<?php echo $this->params->get('tema'); ?>-main"
                            ...
                            <?php if ($this->params->get('tipo-menu') == 1): ?>
                                <div class="header-menu-trigger" id="header-navigation2">
                                    <button class="br-button small circle" type="button"><i
                                            class="fas fa-bars tema-<?php echo $this->params->get('tema'); ?>-main"
                                            style="font-size: 25px;" aria-hidden="true"></i>
                                    </button>
                                </div>
                    ...
                    <div class="header-logo">
                        <div class="logo-om">
                            <?php if ($this->params->get('logo_comlink', '0') == 1): ?>
                                ...
                                <?php elseif ($this->params->get('logo_comlink', '0') == 2): ?>
                                    ...
                                    <?php endif; ?>
                                    <img src="<?php echo $this->params->get('imagem_logo', 'media/templates/site/govbr-ds/img/logo.svg'); ?>"
                                        alt="logo" />
                        ...
                        <div class="header-info">
                            <div class="header-title">
                                <a href="<?php echo Uri::root(); ?>"
                                    title="<?php echo $this->params->get('texto_titulo', 'Template básico'); ?>">
                                    <?php echo $this->params->get('texto_titulo', 'Template básico'); ?>
                                </a>
                            </div>
                            <?php if (!empty($this->params->get('texto_subtitulo', ''))): ?>
                                <div class="header-subtitle">
                                    <?php echo $this->params->get('texto_subtitulo', 'Subtítulo do Header'); ?></div>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="header-govlinks tema-<?php echo $this->params->get('tema'); ?>-main">
                        ...
                        <ul aria-label="Páginas do site">
                            <li>
                                <a href="https://www.gov.br/defesa/"
                                    class="header-sign h8 m-0 header-sign-border tema-<?php echo $this->params->get('tema'); ?>-main-header-border">Ministério
                                    da Defesa</a>
                            </li>
                            <li>
                        ...
                        <div class="header-functions dropdown">
                            ...
                            <div class="br-list">
                                ...
                                <div class="align-items-center br-item">
                                    <button class="br-button circle small" type="button" aria-label="Alto contraste"
                                        onclick="window.toggleContrast()"><i
                                            class="fas fa-adjust tema-<?php echo $this->params->get('tema'); ?>-main"
                                            aria-hidden="true"></i><span class="text">Alto contraste</span>
                                    </button>
                                </div>
                            </div>
                        </div>
                        <?php if ($this->countModules("search")): ?>
                            <div class="header-search-trigger">
                                <button class="br-button circle" type="button" aria-label="Abrir Busca" data-toggle="search"
                                    data-target=".header-search"><i
                                        class="fas fa-search tema-<?php echo $this->params->get('tema'); ?>-main"
                                        aria-hidden="true"></i>
                                </button>
                            </div>
                        <?php endif; ?>
            ...
            <div class="<?php echo $largura ?>">
                ...
                <div class="row">
                                ...
                                <div class="menu-header">
                                    ...
                                    <div class="menu-close">
                                        <button class="br-button circle" type="button" aria-label="Fechar o menu"
                                            data-dismiss="menu"><i
                                                class="fas fa-times tema-<?php echo $this->params->get('tema'); ?>-main"
                                                aria-hidden="true"></i></button>
                                    </div>
                                </div>
                                            ...
                                            <div class="d-flex">
                                                <?php if (!empty($this->params->get('redes_instagram', ''))): ?>
                                                    <a class="br-button circle"
                                                        href="<?php echo $this->params->get('redes_instagram', ''); ?>"
                                                        aria-label="Instagram"><i
                                                            class="fab fa-instagram tema-<?php echo $this->params->get('tema'); ?>-main"
                                                            aria-hidden="true"></i></a>
                                                <?php endif; ?>
                                                <?php if (!empty($this->params->get('redes_twitter', ''))): ?>
                                                    <a class="br-button circle"
                                                        href="<?php echo $this->params->get('redes_twitter', ''); ?>"
                                                        aria-label="Twitter"><i
                                                            class="fab fa-twitter tema-<?php echo $this->params->get('tema'); ?>-main"
                                                            aria-hidden="true"></i></a>
                                                <?php endif; ?>
                                                <?php if (!empty($this->params->get('redes_facebook', ''))): ?>
                                                    <a class="br-button circle"
                                                        href="<?php echo $this->params->get('redes_facebook', ''); ?>"
                                                        aria-label="Facebook"><i
                                                            class="fab fa-facebook-f tema-<?php echo $this->params->get('tema'); ?>-main"
                                                            aria-hidden="true"></i></a>
                                                <?php endif; ?>
                                                <?php if (!empty($this->params->get('redes_youtube', ''))): ?>
                                                    <a class="br-button circle"
                                                        href="<?php echo $this->params->get('redes_youtube', ''); ?>"
                                                        aria-label="YouTube"><i
                                                            class="fab fa-youtube tema-<?php echo $this->params->get('tema'); ?>-main"
                                                            aria-hidden="true"></i></a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    ...
                                    <?php if (!empty($this->params->get('texto_menuinfo', ''))): ?>
                                        <div class="menu-info">
                                            <div class="text-center text-down-01">
                                                <?php echo $this->params->get('texto_menuinfo', 'Desenvolvido com o CMS de c&oacute;digo aberto <strong><a aria-label="Desenvolvido por Comunidade Joomla" href="https://www.joomla.org">Joomla</a></strong>.'); ?>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                    ...
                    <div class="col">
                        ...
                        <?php endif; ?>
                        <div class="main-content  pl-sm-3 tema-<?php echo $this->params->get('tema'); ?>-main-content"
                            id="main-content">
                            ...
                            <?php if ($app->getMenu()->getActive() == $app->getMenu()->getDefault()): ?>
                                <div id="ouvidoria-acessoinformacao">
                                    <div class="row d-block mx-auto text-center" id="ouvidoria-acessoinformacao-header">
                                        <h1 class="tema-<?php echo $this->params->get('tema'); ?>-third">Ouvidoria e Acesso à
                                            Informação</h1>
                                    ...
                                    <div class="row mx-auto px-3 " id="ouvidoria-acessoinformacao-cards">
                                        <div class="col-md">
                                            <div class="br-card hover">
                                                <a
                                                    href="https://falabr.cgu.gov.br/publico/Manifestacao/RegistrarManifestacao.aspx?tipo=1&orgaoDestinatario=<?php echo $this->params->get('atendimentocidadao_siorg', ''); ?>">
                                                    <div
                                                        class="card-content d-flex flex-column justify-content-center align-items-center">
                                                        <i class="fas fa-bullhorn tema-<?php echo $this->params->get('tema'); ?>-third"
                                                            aria-hidden="true"></i><span class="br-engengrau">Denúncia</span>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md">
                                            <div class="br-card hover">
                                                <a
                                                    href="https://falabr.cgu.gov.br/publico/Manifestacao/RegistrarManifestacao.aspx?tipo=5&orgaoDestinatario=<?php echo $this->params->get('atendimentocidadao_siorg', ''); ?>">
                                                    <div
                                                        class="card-content d-flex flex-column justify-content-center align-items-center">
                                                        <i class="fas fa-comments tema-<?php echo $this->params->get('tema'); ?>-third"
                                                            aria-hidden="true"></i><span class="br-engengrau">Solicitação</span>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md">
                                            <div class="br-card hover">
                                                <a
                                                    href="https://falabr.cgu.gov.br/publico/Manifestacao/RegistrarManifestacao.aspx?tipo=3&orgaoDestinatario=<?php echo $this->params->get('atendimentocidadao_siorg', ''); ?>">
                                                    <div
                                                        class="card-content d-flex flex-column justify-content-center align-items-center">
                                                        <i class="fas fa-thumbs-up tema-<?php echo $this->params->get('tema'); ?>-third"
                                                            aria-hidden="true"></i><span class="br-engengrau">Elogio</span>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md">
                                            <div class="br-card hover">
                                                <a
                                                    href="https://falabr.cgu.gov.br/publico/Manifestacao/RegistrarManifestacao.aspx?tipo=2&orgaoDestinatario=<?php echo $this->params->get('atendimentocidadao_siorg', ''); ?>">
                                                    <div
                                                        class="card-content d-flex flex-column justify-content-center align-items-center">
                                                        <i class="fas fa-thumbs-down tema-<?php echo $this->params->get('tema'); ?>-third"
                                                            aria-hidden="true"></i><span class="br-engengrau">Reclamação</span>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
        ...
        <footer class="<?php echo $cor_footer ?> tema-<?php echo $this->params->get('tema'); ?>-bg" id="footer">
            <div class="<?php echo $largura ?>">
                <div class="logo"><img src="<?php echo $this->params->get('imagem_logo_footer', $logo_footer); ?>"
                        alt="Imagem" /></div>
                <?php if ($this->countModules('menumapa')): ?>
                    <div class="horizontal br-footer-menu tema-<?php echo $this->params->get('tema'); ?>-menu"
                        data-toggle="data-toggle" data-sub="data-sub">
                    ...
                    <div class="row align-items-end justify-content-between py-5">
                        <?php if ($this->params->get('redes_sociais', '1')): ?>
                            <div class="col social-network">
                                ...
                                <?php if (!empty($this->params->get('redes_instagram', ''))): ?>
                                    <a class="br-button circle large mr-3"
                                        href="<?php echo $this->params->get('redes_instagram', ''); ?>"
                                        aria-label="Instagram"><i aria-hidden="true"
                                            class="fab fa-instagram tema-<?php echo $this->params->get('tema'); ?>-main"></i></a>
                                <?php endif; ?>
                                <?php if (!empty($this->params->get('redes_twitter', ''))): ?>
                                    <a class="br-button circle large mr-3"
                                        href="<?php echo $this->params->get('redes_twitter', ''); ?>" aria-label="Twitter"><i
                                            aria-hidden="true"
                                            class="fab fa-twitter tema-<?php echo $this->params->get('tema'); ?>-main"></i></a>
                                <?php endif; ?>
                                <?php if (!empty($this->params->get('redes_facebook', ''))): ?>
                                    <a class="br-button circle large mr-3"
                                        href="<?php echo $this->params->get('redes_facebook', ''); ?>" aria-label="Facebook"><i
                                            aria-hidden="true"
                                            class="fab fa-facebook tema-<?php echo $this->params->get('tema'); ?>-main"></i></a>
                                <?php endif; ?>
                                <?php if (!empty($this->params->get('redes_youtube', ''))): ?>
                                    <a class="br-button circle large mr-3"
                                        href="<?php echo $this->params->get('redes_youtube', ''); ?>" aria-label="YouTube"><i
                                            aria-hidden="true"
                                            class="fab fa-youtube tema-<?php echo $this->params->get('tema'); ?>-main"></i></a>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                        <div class="col assigns text-right">
                            <?php if ($this->params->get('imagem_footer_acesso', '1')): ?>
                                <a class="d-inline-block ml-4" href="https://www.gov.br/acessoainformacao"><img
                                        src="<?php echo $this->params->get('cor_footer') ? 'media/templates/site/govbr-ds/img/acesso_footer_claro.svg' : 'media/templates/site/govbr-ds/img/acesso_footer.svg'; ?>"
                                        alt="Acesso a Informação" /></a>
                            <?php endif; ?>
                            <?php if ($this->params->get('imagem_footer_brasil', '1')): ?>
                                <a class="d-inline-block ml-4" href="https://www.gov.br/"><img
                                        src="<?php echo $this->params->get('imagem_footer_brasil_src', 'media/templates/site/govbr-ds/img/brasil_footer.svg') ?>"
                                        alt="Imagem" /></a>
                            <?php endif; ?>
                        </div>
                    </div>
        ...
        <button id="gotop" class="br-button primary circle backtotop" aria-label="Ir para o topo" onclick="goTop()"><i
...
<script>
    if (document.getElementById('header-navigation2')) {
